...
class Rope{
    ...
    public ropeMax:any;
	/**绳子最大长度*/
    public ropeMaxLength:number;
	public ropeMinLength:number;
	/**绳子透明度*/
    public ropeAlpha:number;
	/**绳子已达到最长*/
	public isRopeMax:boolean;
	/**绳子已连接到糖果上*/
	public isRopeContactCandy:boolean;
	public isCheck:boolean;
	public isContact:boolean;
    constructor(dataPos,datacountlength,datacontact){
